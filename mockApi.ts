...
export const mockResults = (url: string) => {
  switch (url) {
    case "/people/Leia":
      return people.leia;
    case "/people/Luke Skywalker":
      return people.lukeSkywalker;
    case "/starships/12":
      return starShips.s12;
    case "/starships/22":
      return starShips.s22;
    case "/films":
      return films;
    case "species/1":
      return species.s1;
